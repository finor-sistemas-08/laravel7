  ...
  <ul class="nav navbar-nav">
      ...
      <li class="{{ activarLink('usuario.create')   ||  request()->routeIs('showLogin') ? 'active' :'' }}">
          ...
          <ul class="dropdown-menu">
              <li class="{{ request()->routeIs('usuario.create') ? 'active' :''}}"><a href="{{ route('usuario.create') }}">Registrate</a></li>
              <li class="{{ request()->routeIs('showLogin') ? 'active' :''}}"><a href="{{ route('showLogin') }}">Ingresa</a></li>
          </ul>
      </li>             
  </ul>
</div>
